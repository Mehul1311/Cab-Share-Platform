  ...
  return (
    <div className="container animate-fade-in" style={{ paddingTop: '85px', paddingBottom: '90px', position: 'relative' }}>
      ...
      <div style={{ maxWidth: '960px', margin: '0 auto' }}>
        ...
        <div className="glass-panel" style={{ padding: '40px', marginBottom: '56px', background: 'rgba(15, 23, 42, 0.45)' }}>
        ...
        <div style={{ marginBottom: '56px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '24px' }} className="pillar-grid">
            <div style={{ padding: '24px', background: 'rgba(255,255,255,0.01)', border: '1px solid rgba(255,255,255,0.04)', borderRadius: '16px' }}>
            ...
            <div style={{ padding: '24px', background: 'rgba(255,255,255,0.01)', border: '1px solid rgba(255,255,255,0.04)', borderRadius: '16px' }}>
              <div style={{ color: 'var(--vibrant-cyan)', marginBottom: '12px' }}><Leaf size={24} /></div>
            ...
            <div style={{ padding: '24px', background: 'rgba(255,255,255,0.01)', border: '1px solid rgba(255,255,255,0.04)', borderRadius: '16px' }}>
              <div style={{ color: 'var(--orange-accent)', marginBottom: '12px' }}><Users size={24} /></div>
        ...
        {/* Team block */}
        <div className="glass-panel" style={{ padding: '40px', background: 'rgba(15, 23, 42, 0.45)', textAlign: 'center' }}>
